...
/*   Updated: 2025/03/24 21:58:52 by abidolet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parse_cylinder(t_scene *scene, char **tokens)
{
	...
	parse_vector(scene, &normal, tokens[2]);
	...
	parse_color(scene, &scene->cylinders->color, tokens[5]);
}
...
void	parse_plane(t_scene *scene, char **tokens)
{
	...
	parse_color(scene, &scene->planes->color, tokens[3]);
}
...
void	parse_sphere(t_scene *scene, char **tokens)
{
	...
	parse_color(scene, &scene->spheres->color, tokens[3]);
}
